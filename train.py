...
from utils.model_inference import save_models
from utils.model_training import train_random_forest, train_gradient_boosting
...
if __name__ == "__main__":
    ...
    # Train Decision Tree
    # dt_model, dt_pred = train_decision_tree(X_train, y_train, X_test)
    ...
    gb_model, gb_pred = train_gradient_boosting(X_train, y_train, X_test)
    save_models(gb_model, "Gradient Boosting")

    # 5. Evaluate models
    print("\nStep 4: Evaluating models...")
    results = [
        # evaluate_model(dt_model, X_test, y_test, dt_pred, "Decision Tree"),
