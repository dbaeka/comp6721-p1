...
from utils.analysis import explore_data, visualize_data
...
if __name__ == "__main__":
    ...
    visualize_data(training_dir, n_samples=5, save_plots=save_plots, output_dir=output_dir)

    X, y = load_and_preprocess_images(training_dir)

    print("\nStep 2: Performing exploratory data analysis...")
    explore_data(X, y, save_plots=save_plots, output_dir=output_dir)
    ...
    # Train Decision Tree
    dt_model, dt_pred = train_decision_tree(X_train, y_train, X_test, save_plots=save_plots, output_dir=output_dir)
    ...
    sm_dt_model, sm_dt_pred = semi_supervised_learning(X_train, y_train, X_test, save_plots=True, output_dir='plots')
    save_models(sm_dt_model, "Semi-Supervised Decision Tree")

    print("\nStep 4: Evaluating models...")
    results = [
        evaluate_model(dt_model, X_test, y_test, dt_pred, "Decision Tree", save_plots=save_plots,
    ...
    metrics_df = compare_models(results, save_plots=save_plots, output_dir=output_dir)
